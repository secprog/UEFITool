...
namespace Subtypes {
enum ImageSubtypes { IntelImage = 70, UefiImage };
...
enum VolumeSubtypes { UnknownVolume = 90, Ffs2Volume, Ffs3Volume };
...
enum PaddingSubtypes { ZeroPadding = 110, OnePadding, DataPadding };
}; // namespace Subtypes
