...
typedef struct _APTIO_CAPSULE_HEADER {
  ...
  UINT16 RomImageOffset; // offset in bytes from the beginning of the capsule
                         // header to the start of
                         // the capsule volume
                         //! TODO: Enable certificate and ROM layout reading
  // UINT16                RomLayoutOffset;    // offset to the table of the
  // module descriptors in the capsule's volume
...
#define EFI_FILE_ERASE_POLARITY                                                \
  0x80 // Defined as "all other bits must be set to ERASE_POLARITY" in UEFI PI
...
const QByteArray
    EFI_GUIDED_SECTION_CRC32 // FC1BCDB0-7D31-49AA-936A-A4600D9DD083
    ("\xB0\xCD\x1B\xFC\x31\x7D\xAA\x49\x93\x6A\xA4\x60\x0D\x9D\xD0\x83", 16);

const QByteArray
    EFI_GUIDED_SECTION_TIANO // A31280AD-481E-41B6-95E8-127F4C984779
...
const QByteArray
    EFI_GUIDED_SECTION_LZMAF86 // D42AE6BD-1352-4BFB-909A-CA72A6EAE889
    ("\xbd\xe6\x2a\xd4\x52\x13\xfb\x4b\x90\x9a\xca\x72\xa6\xea\xe8\x89", 16);

const QByteArray
    EFI_FIRMWARE_CONTENTS_SIGNED_GUID // 0F9D89E8-9259-4F76-A5AF-0C89E34023DF
    ("\xE8\x89\x9D\x0F\x59\x92\x76\x4F\xA5\xAF\x0C\x89\xE3\x40\x23\xDF", 16);

const QByteArray
    EFI_GUIDED_SECTION_GZIP_QC // 1d301fe9-be79-4353-91c2-d23bc959ae0c
